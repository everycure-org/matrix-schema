# Contributing to matrix-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
matrix-schema. These guidelines are not strict rules.
...
The matrix-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the matrix-schema technical leads
...
[issues]: https://github.com/everycure-org/matrix-schema/issues/
[pulls]: https://github.com/everycure-org/matrix-schema/pulls/
