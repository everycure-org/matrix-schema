...
LINKML_SCHEMA_NAME=matrix_schema
LINKML_SCHEMA_AUTHOR=Nicolas Matentzoglu <nicolas.matentzoglu@gmail.com>
LINKML_SCHEMA_DESCRIPTION=The collected MATRIX schemas
LINKML_SCHEMA_SOURCE_PATH=src/matrix_schema/schema/matrix_schema.yaml
